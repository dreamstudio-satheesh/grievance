...
@section('title') @lang('translation.banner') @endsection
@section('css')
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row banner-wrapper">
                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 project designing development"  data-category="designing development">
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-1.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-1.jpg') }}" alt="" />
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-2.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-3.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-4.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-5.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-5.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-6.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-6.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-7.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-8.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-8.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                                    <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                </div>
                                            </a>
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-9.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-9.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-10.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-10.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-11.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-11.jpg') }}" alt="" />
                                                <div class="banner-overlay">
                                    ...
                                    <div class="banner-box card card-border-effect-none">
                                        <div class="banner-container">
                                            <a class="image-popup" href="{{ URL::asset('assets/images/small/img-12.jpg') }}" title="">
                                                <img class="banner-img img-fluid mx-auto" src="{{ URL::asset('assets/images/small/img-12.jpg') }}" alt="" />
                                                <div class="banner-overlay">
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/js/pages/banner.init.js') }}"></script>
