            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                    <div class="edit">
                        ...
                        '.'name :'. $complaint->username) }}" class="btn btn-success btn-label" > <i class="bx bxl-whatsapp label-icon align-middle fs-16 me-2"></i>Whatsapp to JE</a>
                    </div>
                    <div class="remove">
                        <a href="https://wa.me/6379108040?text={{ urlencode($complaint->subject.'
                        '.'name :'. $complaint->username) }}" class="btn btn-primary btn-label" > <i class="bx bxl-whatsapp label-icon align-middle fs-16 me-2"></i>Whatsapp to AE</a>
