<div>
    ...
    @if (!is_null($divisions))
            ...
            <div class="mb-3">
                ...
                <select name="division_id"  wire:model="SelectedDivision"  class="form-control" >
            ...
            <div class="mb-3">                
                ...
                <select name="dsreet_id"   class="form-control" >
                    <option selected=""  value="">Select</option>
    ...
    @if (!is_null($panchayats))
        ...
        <div class="mb-3">
            ...
            <select name="panchayat_id"  wire:model="SelectedPanchayat"  class="form-control" >
                <option selected=""  value="">Select</option>
        ...
        <div class="mb-3">                
            ...
            <select name="ward_id" wire:model="SelectedWard"  class="form-control" >
        ...
        <div class="mb-3">                
            <label class="form-label text-muted">Select Street</label>
            <select name="sreet_id"   class="form-control" >
                <option selected=""  value="">Select</option>
