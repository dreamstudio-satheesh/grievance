...
@section('content')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="calculate-shiping">
                                    ...
                                    <ul class="codex">
                                        ...
                                        <select>
                                            <option value="volvo">Salem</option>
										...
										<li>
                                            ...
                                            <div class="outline-select">
                                                ...
                                                <option value="Select">Select</option>
                                                    <option value="01">Panchayat</option>
                                                    <option value="02">Division</option>
										...
										<li>
                                            ...
                                            <select>
                                            <option value="Select">Select</option>
                                                <option value="01">Arasiramani</option>
                                                <option value="02">Attayampatty</option>
                                                <option value="03">Ayothiyapattanam</option>
	...
	<option value="03">03</option>
										...
										<li>
                                            ...
                                            <div class="outline-select">
                                        <select>
                                            <option value="01">Cherry Road</option>
											<option value="01">Trichy - Salem Road</option>
											<option value="01">2nd Agraharam</option>
